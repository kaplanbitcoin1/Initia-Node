...
```
* Sayfanın sonuna ok tuşları ile gidin ya da ctrl+w yapıp arama yerine oracle yazın, enterlayın. 1.ci fotoğraftaki bilgileri 2.ci fotoğraftakiler ile değiştirelim
```console
enabled = "true"
```
```console
